...
// ============== RF related section ========
#define RF_TWO_ANTE_POWER_DIFF             25001 //"[TWO_ANTE_POWER_DIFF]: valid: %d, large ante patch: %d(0:s0 ; 1:s1), power diff value: %d"
...
#define RF_THERMAL_TRACKING_POWER_DBG      25003 //"default_power_index(max: 0x%x, 1M: 0x%x, 2M: 0x%x, 3M: 0x%x, LE: 0x%x), cur_power_index(1M: 0x%x, 2M: 0x%x, 3M: 0x%x, LE: 0x%x), step_index(default: 0x%x, max: 0x%x)"
