...
#define LE_MSG_HANDLE_RX_PKT_IN_TASK 3237 //"LE_RX PKT: type %d src %d rx_bytecnt %d conn_entry %d ce_cnt %d"
...
#define LE_MSG_GEN_LL_CONN_UPDT_REQ_NEW 3333 //"[LL]Gen LL_CONN_UPDT_REQ new (%d): cur:%d, instant:%d, slv_l(ori):%d, win_sz:%d, win_sz_ofst:%d, win_ofst:%d, interval:%d, slv_l:%d, supto:%d"
#define MSG_TASK_QUEUE_FULL_BM 3334 //"Warnning!! Task Queue Full = bm:%08x, drop:%d, seq:%d %d %d %d %d %d %d %d"
#define LE_MSG_LE_HW_REG_WRONG_CONN_STATUS 3335 //"[LE] CONN wrong status: term_reason: %d, hw_conn_num: %d, conn_cnts: %d"
#define LE_MSG_KILL_CONN_ENT_MISMATCH 3336 //"[LL] Killed conn entry mismatch: conn_ent: %d, hw_conn_ent: %d"

#define MSG_MBOX_IN_COMMAND_PARAM 3403 //"[MB] wl2bt => %08x %08x"
#define MSG_MBOX_OUT_COMMAND_PARAM 3404 //"[MB] bt2wl <= %08x %08x"
#define MSG_OS_TIMER_POOL_EMPTY_CHECK 3405 //"[os_timer empty check] %d : %x %x %x %x %x %x %x %x : %x %x %x %x %x %x %x %x !!!"
#define MSG_RT8723_RF_THERMAL_TIMER_NEW 3407 //"NewThermalTimerCallback..thermal:(now %d diff %d default %d), track:(txpwr %d cfo %d), mode = %d"
#define MSG_HCI_VENDOR_SET_THERMAL_VALUE_AND_POUTER 3408 //"HciVendor: Pouter Mode En %d, current_thermal %d"
#define MSG_BT_WDG_TIMEOUT_DBG 3444 //"Wdg_Timeout!!!(pre_stats) isr %d, isr_bm %02x,  cpu_idle %d, sig_id %d, isr_cause %08x, isr_cnt %d, last_epc 0x%08x"
#define MSG_DISPLAY_TIMER_FUNC_POINTER 3499 //"[timer id %d] %08x %08x %08x %08x : %08x %08x %08x %08x :  %08x %08x %08x %08x : %08x %08x %08x %08x"
...
#define MSG_3DD_RP_RX_AN                3707 //"[3DD-RP] 3DG AN Received!! (clk:0x%08x)"
#define MSG_3DD_SHOW_BEACON             3708 //"[3DD-RP] Left(%d %d) Right(%d %d)"
#define MSG_PERI_INQ_DBG                3709 //"Peri-Inquiry Param:  Lap %06x, Inq period (max %d, min %d), Inq Len %d, NumRsp %d, status %d .."
...
#define DAPE_TEST_LOG542 4642 //"LE connection update.entry:%d, reg0x22:0x%04x, reg0x24:0x%04x"
#define DAPE_TEST_LOG543 4643 //"le_cnt:%d, le_bm:%04x, adv:%d(0x%04x), scan:%d(int0x%04x,win0x%04x),dup:%d, init:%d(int0x%04x,win0x%04x)"
...
#define DAPE_TEST_LOG546 4646 //"[LE SELF CONN UPDT]slot_offset:(current:%d, new:%d) ce_interval:%d. TxOfst:%d"
...
#define DAPE_TEST_LOG550 4650 //"(LE) le_cnt:%d, le_bm:%04x, adv:%d(%d), scan:%d(int:%d,win:%d),dup:%d, init:%d(int:%d,win:%d), m:%d, en0(i:%d c:%d r:%d s:%d) en1(i:%d c:%d r:%d s:%d)"
#define DAPE_TEST_LOG551 4651 //" Warning!! Ignore Mailbox ENABLE WLAN ACTIVE because WHCK running. %x"
#define DAPE_TEST_LOG552 4652 //" Warning!! Ignore Mailbox HCI_VENDOR_SUB_CMD_BT_SET_PTATABLE because WHCK running. %x"
#define DAPE_TEST_LOG553 4653 //"(LE) le_cnt:%d, le_bm:%04x, adv:%d(%d), scan:%d(int:%d,win:%d),dup:%d, init:%d(int:%d,win:%d), m:%d, en0(i:%d c:%d r:%d s:%d) en1(i:%d c:%d r:%d s:%d)"
#define DAPE_TEST_LOG553 4653 //"(LE) le_cnt:%d, le_bm:%04x, adv:%d(%d), scan:%d(int:%d,win:%d),dup:%d, init:%d(int:%d,win:%d), m:%d, en0(i:%d c:%d r:%d s:%d) en1(i:%d c:%d r:%d s:%d)"
#define DAPE_TEST_LOG559 4659 //" Detect Host Suspend. (clk 0x%08x)"
#define DAPE_TEST_LOG560 4660 //" Detect Host Leave Suspend! (clk 0x%08x)"
#define DAPE_TEST_LOG561 4661 //" Drop Event(0x%x) because Host is suspend (clk 0x%08x)"
#define DAPE_TEST_LOG562 4662 //" Drop ACL pkt(0x%02x %02x %02x %02x %02x) because Host is suspend(clk 0x%08x)"
#define DAPE_TEST_LOG563 4663 //" Warning!! Event free poll %d (total 8)left."
#define DAPE_TEST_LOG564 4664 //" Send Disconnect Complete Event to Host at Host Suspend. Disconn Reason 0x%02x."
#define LOG_PEND_PKT_ON_HOST_SUSPENSION 4665 //" Pend packet (type: %d, data: %02x:%02x:%02x:%02x:%02x:%02x) on host suspension"
#define LOG_SEND_PKT_ON_HOST_RESUMPTION 4666 //" Send packet (type: %d, data: %02x:%02x:%02x:%02x:%02x:%02x) on host resumption"
#define DAPE_TEST_LOG567 4667 //" latency_max(%d -> %d)(ce_counter %d)"
#define DAPE_TEST_LOG568 4668 //" [clk 0x%08x][%dus]anchor_clk 0x%08x latency_meas counter %d tx %d %dticks = %d us (sum %d max %d min %d)"
...
#define LPS_LOG_042 9342 //"Native:0x%08x PN0:0x%08x PN1:0x%08x PN2:0x%08x PN3:0x%08x"
...
#define MDM_LOG_006 9506 //"<MODEM DEBUG> captured_flag %d, INDEX %d, hex2dec('%X') hex2dec('%X') hex2dec('%X') hex2dec('%X') hex2dec('%X') hex2dec('%X') hex2dec('%X') hex2dec('%X') hex2dec('%X') hex2dec('%X') hex2dec('%X') hex2dec('%X') hex2dec('%X') hex2dec('%X') hex2dec('%X') hex2dec('%X') "
...
#define LC_PCM_CODEC_REG  5001  //" PCM Codec Reg, 0x9E=%04x, 0xDE=%04x, 0x1EC = %04x, 0x1EE = %04x, 0xE0 = %04x"
...
// ============= morgan add mailbox =====
#define MAILBOX_BT_AUTO_REPORT_ENABLE 11800 //"<MAILBOX> Set BT_AUTO_REPORT_ENABLE value = %d"
#define MAILBOX_BT_SET_TXRETRY_REPORT_PARAM 11801 //"<MAILBOX> Set BT_SET_TXRETRY_REPORT_PARAM time_period = 0x%x threshold = 0x%x"
#define MAILBOX_BT_SET_PTATABLE 11802 //"<MAILBOX> Set BT_SET_PTATABLE Config =%d Switch=%d TxTable=0x%02x RxTable=0x%02x"
#define MAILBOX_SET_BT_PSD_MODE 11803 //"<MAILBOX> Set SET_BT_PSD_MODE = %d fast al lon= %d recover=%d"
#define MAILBOX_HID_PROFILE_ENABLE_CMD 11804 //"<MAILBOX> Set HID_PROFILE_ENABLE_CMD value = %d"
#define MAILBOX_BT_AUTO_REPORT_ENABLE_2 11805 //"<MAILBOX> Set BT_AUTO_REPORT_ENABLE value = %d"
#define MAILBOX_SET_BT_LNA_CONSTRAINT 11806 //"<MAILBOX> Set SET_BT_LNA_CONSTRAINT value = %d"
...
#define PTA_DISPLAY_BT_INFO_MESSAGE3 12051 //"<PTA> Conn=%d SCO=%d INQ=%d ACL=%d SCO busy=%d TXRetry=%d HID=%d HOGP=%d voice_over_HOGP=%d A2DP=%d FTP=%d out_data2 %x rssi_sum %d"
...
#define MAILBOX_DBG_INFO 12053 //"<MAILBOX> Mailbox DBG Info= 0x%8x"
#define BT_3DD_MSG_SEND_VENDOR_EVT_SYNC_TOGGLE 12054 //"<3DD> Send HCI Event 0xFF sub code0x28 toggle=%d"
#define MAILBOX_DBG_INFO_TIMER_FUNCTION_PATCH 12055 //"<MAILBOX> Enter mailbox timer function patch entry 0x%1x"
#define PTA_PRIORITY 12056 //"<PTA> set priority 0x%2x"
#define MAILBOX_PATCH 12057 //"<MAILBOX> HCI reset replace patch"
#define BT_REPORT_REDUCED_LOG 12058 //"<coex info> INQ/PAGE = %d ACL=%d SCO busy=%d HID=%d A2DP=%d FTP=%d"
#define DRIVER_REPORT_BITPOOL 12059 //"driver provide a2dp bitpool info = %x"


#define MAILBOX_TASK 12060 //"<MAILBOX> GET MAILBOX CMD"
#define MAILBOX_TASK_READ 12061 //"<MAILBOX> Get mailbox read command = %x"
#define I2C_ENABLE_INFO 12062  //"<MAILBOX> set I2C enable"
#define PTA_MAILBOX_WRITE_INFO 8102 //"<PTA> mailbox write index= %d mailbox outdatabusy= %d"
#define PTA_MAILBOX_WRITE_FLAG 8101 //"<PTA> mailbox_out_data_ready = %d mailbox_cnt=%d data=0x%x 0x%x"
#define PTA_I2C_ENABLE 8107 //"<PTA> i2c enable value =%d "
#define I2C_RESET 12071 //"<I2C> reset by non-ack timeout"
#define I2C_RESET_NORMAL 12702 //"<I2C> reset by 6 sec no response timeout"
#define HCI_EVENT_REPORT_SEND 12703 //"<PTA> send evt code=%x"
#define MAILBOX_CMD_SETAUTO_REPORT_ENABLE 12704 //<MAILBOX> Set Auto report enable = %d"
#define PTA_COEX_INFO 12705 //"<Bt Coex Info> LowByte = 0x%x , HighByte = 0x%x"
...
//#define HCI_VENDOR_3DD_subcode_2 12092 //"<3DD> lsod =%d lscd =%d rsod =%d rscd =%d"
...
#define MP_PKT_TX_UPDATE_INFO 12800 //"MP_PACKET_TX_UPDATE_INFO , used_time = %d(us) , pkt_cnt = %d , tx_bits = %d"
#define MP_SET_PKT_TX_UPDATE 12801 //"MP_PKT_TX_UPDATE:pkt tx finish!"
#define MP_SET_PKT_TX_RETRIGGER 12802 //"MP_PKT_TX_COUNTER_OVERFLOW!!!RETRIGGER"
#define MP_PKT_RX_UPDATE_OVERFLOW 12803 //"MP_PKT_RX_UPDATE_ALMOST_OVERFLOW!!!"
#define MP_PKT_RX_UPDATE_INFO 12804 //"MP_PKT_RX_UPDATE_INFO , RX_RSSI = %d ,RX_COUNT = %d , BER = %f"
#define MP_PKT_TX_BEGIN 12805 //"MP_PKT_TX_Begin!!"
#define MP_ERROR_PACKET_LENGTH 12806 //"MP packet tx/rx error vendor command length"
#define MP_PKT_TRX_CMD_PARSER 12807 //"pattern:%x , tx_interval:%x , tx_power_index:%x , is_whiten:%x , whiten_coeff:%x , rf_chnl:%x , pkt_type=%x , multi_rx_enable:%x , is_pseudo_outer:%x , is_pkt_tx:%x , header:%x , tx_pkt_cnt:%x  , length:%x"
#define MP_PKT_RX_ENABLE 12808 //" HCI_VENDOR_MP_PACKET_RX_ENABLE !!"
#define MP_PKT_TX_ENABLE 12809 //" HCI_VENDOR_MP_PACKET_TX_ENABLE !!"
#define MP_PKT_TX_REPORT 12810 //" MP_PKT_TX_REPORT: total pkt tx = %x , total tx bit = %x"
#define MP_PKT_RX_REPORT 12811 //" MP_PKT_RX_REPORT: pkt rx = %x , rx bits = %x , rx error bits = %x , BER = %x , CFO = %x , RSSI = %x"
#define MP_CONT_TX_BEGIN 12812 //"MP_cont_TX_Begin!!"
#define MP_CONT_TX_BEGIN_PARAMETER 12813 //"ch = %x , pkt_type = %x , tx_gain_index = %x , tx_gain_value = %x , pkt_cnt = %x , payload_type = %x , pkt_header = %x , whitening_coeff = %x , tx_dac = %x , hit_target = %x , payload_len = %x"
#define MP_ERROR_CONT_TX_PACKET_LENGTH 12814 //"MP cont tx error vendor command length"
#define MP_3WIRE_MESSAGE1 12815 //"RTL8761_3wire_write START"
#define MP_3WIRE_MESSAGE2 12816 //"RTL8761_3wire_write STOP"
#define MP_3WIRE_MESSAGE3 12817 //"RTL8761_3wire_read START"
#define MP_3WIRE_MESSAGE4 12818 //"RTL8761_3wire_read STOP"
#define MP_3WIRE_MESSAGE5 12819 //"RTL8761_3wire_read addr = 0x%x , addr_bit_num = %x , data_bit_num = 0x%x"
#define MP_3WIRE_MESSAGE6 12820 //"RTL8761_3wire_write addr = 0x%x , addr_bit_num = %x , data_bit_num = 0x%x , data = 0x%x"
#define TXLCK 12821 //"TX LCK ,%x th times : channel = %x , val = %x"
#define RXLCK 12822 //"RX LCK ,%x th times: channel = %x , val = %x"
#define TRXLCKK 12824 //"LCK ,%x th times: channel = %x , TX_val = %x , RX_val = %x , same ? %x"
#define TRXLCK 12823 //"ms = %x================================"
#define TXLCKMIX 12825 //"LCK TX result,: channel = %d , original = %x , 0x7100 = %x , 0x7200 =  %x , 0x7300 = %x"
#define RXLCKMIX 12826 //"LCK RX result,: channel = %d , original = %x , 0x7100 = %x , 0x7200 =  %x , 0x7300 = %x"
...
#define LOG_TV_POWERON_MSG 13013 //"<TV> Notify Power OnOff(%d) LE always scan:%d(%d/%d)"
...
#define LOG_TV_AUTO_PAIR_AD_MATCH 13022 //"[TV] ad match: ad_len: %d, ad_data: %02x:%02x"
#define LOG_TV_AUTO_PAIR_AD_RCU_ADDRESS_CHECK 13023 //"[TV] ad match: rcu addr: %02x:%02x:%02x:%02x:%02x:%02x"
#define LOG_TV_AUTO_PAIR_AD_RCU_ADDRESS_MASK 13024 //"[TV] ad match: rcu addr mask: %02x:%02x:%02x:%02x:%02x:%02x"
#define LOG_TV_AUTO_PAIR_AD_RCU_ADDRESS 13025 //"[TV] ad match: rcu addr to check: %02x:%02x:%02x:%02x:%02x:%02x"
#define LOG_TV_AUTO_PAIR_AD_RCU_ADDRESS_CHECK_RESULT 13026 //"[TV] ad match: rcu addr check result :%d"
#define LOG_TV_AUTO_PAIR_AD_CHECK_TYPE 13027 //"[TV] ad match: ad type to check: %02x"
#define LOG_TV_AUTO_PAIR_CHECK 13028 //"[TV] ad match: auto-pair enable: %d, check_data_len: %d"

#define LOG_LE_RX_FLOW_CTRL 13099 //"LE rx flow control: ce_counter: %d, free buffer size: %d, flow_ctrl:%d"
#define PROFILE_INFO_CHECK 13100 //"BUSY PROFILE CHECK , SCO_bit[0]=%d HID_bit[1]=%d A2DP_bit[2]=%d FTP_bit[3]=%d HOGP_bit[4]=%d voice_over_hogp_bit[5]=%d"
#define MAILBOX_CMD_COMPLETE_EVENT  13101  //"<----MAILBOX_CMD_COMPLETE_EVENT:code:%02x ,sub_cmd=%02x "
