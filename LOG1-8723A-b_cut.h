...
#define ZERO_RSSI                                109      //"Zero RSSI.%x.%d"
...
#define ERROR_TIMER_LEAK                        242      //"Error : Timer leak. %d.%d.%d"
...
#define DUMMY_NBC_TIMEOUT    466    //"Dummy NBC Timeout"
...
#define TIMER_IS_IN_THE_CALENDAR_TABLE_BUT_NOT_RUNNING    1247    //"Timer %d is in the Calendar table but not running "
...
#define BT_FW_HCI_1_2_CMDS_1414  1322  //"exist esco connection"
#define BT_FW_HCI_1_2_CMDS_1418  1323  //"Cannot re-negotiate eSCO parameters now"
#define BT_FW_HCI_1_2_CMDS_1435  1324  //"new sync link"
#define BT_FW_HCI_1_2_CMDS_1443  1325  //"exist sco link, can not change parameters of the existing link"
#define BT_FW_HCI_1_2_CMDS_1455  1326  //"The provided Connection Handle is not valid"
#define BT_FW_HCI_1_2_CMDS_1478  1327  //"%d link, acl ce index %d, ce status = %d"
...
#define BT_FW_HCI_TASKS_146  1355  //"---->HCI_CMD:opcode:%04x len:%d, %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x"
#define BT_FW_HCI_TASKS_150  1356  //"Para:[%02x][%02x][%02x]"
#define BT_FW_HCI_TASKS_210  1357  //"free cmd buffer failed"
#define BT_FW_HCI_TASKS_260  1358  //"<----HCI_EVENT:code:%02x len:%d, %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x"
...
#define LC_ISR_1408  1467  //"ParkConIntr.Made lc_slave_init_unpark_pending = FALSE.%x.%x"
...
#define LC_ISR_2104  1472  //"rs %d, free %d"
...
#define LC_SYNC_LINKS_293  1524  //"USING CODEC"
...
#define LC_SYNC_LINKS_3267  1539  //"DetachSCOClr.SCA_PRIORITY_REGISTER:Wr.%x."
...
#define LC_TASK_2267  1586  //"FHS rx:%x.%x.%x. %x.%x.%x.%x.%x.%x. %x.%x.%x.%x.%x.%x. %x.%x. %x.%x. %x.%x."
...
#define LMP_AFH_962  1665  //"Set AFH: ce_idx %d, rem role %d, enable %d, clock %06x, map %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x, state %d"
...
#define LMP_SCO_902  1713  //"cd_index = %d, status = 0x%x"
#define LMP_SCO_906  1714  //"index %d, entry_index = %d, conn_status = %d"
#define LMP_SCO_942  1715  //"lmp_get_sco_ce_index_from_sco_handle, sco_handle = %d, ce_index = %d"
...
#define LMP_SYNC_LINKS_2622  1743  //"lmp_create_esco_connection, esco ce index = %d"
...
#define EFUSE_POWER_INFO 2440 //"EFUSE power option: 0x%x"
...
#define MSG_VENDOR_SET_THERMAL_DEFAULT  2491 //"VendorCmd: Set Thermal Deault = %d"
#define MSG_VENDOR_SET_THERMAL_INTERVAL 2492 //"VendorCmd: Set Thermal Interval = %d ms"
#define MSG_CFO_CAP_INFO 2493 //"CFO Mesg: table=%x %x %x %x %x %x %x %x %x %x %x %x %x %x %x %x %x, index=%d, n_now=%d, capoffset=%x"
#define MSG_VENDOR_SET_CFO_TRACK 2494 //"VendorCmd: Enable CFO Track = %d"

#define MSG_COEXISTENCE_MAX_RSSI 2996 //"coex msg: max rssi = %d dBm, samples = %d pcs, last 16 pkts(dBm) : %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d"
#define MSG_FW_SHOW_RX_ERROR 2997 //"reschedule msg: lut_idx %d rx pkt %d (hec err %d crc err %d)"
#define MSG_FW_MAIN_SHOWTIME 2998 //"firmware-4.0 version = %04x %04x cpu clock = %d my_bt_addr = 0x%02x%02x%02x%02x%02x%02x"
#define MSG_GPIO_INTR_DBG 2999 //"GPIO INTR: state %x bton_intr_info %x gpio sta %x pwr_ctrl %x pwr_opt %x"
...
#define LMP_MSG_POWER_CTRL 3061 //rssi: %d, rssi_dbm: %d, max_rssi:%d, min_rssi:%d: pdu send:%d, power resp:%d, count:%d"
...
#define MSS_MSG_ESCO_END 3097 //"**eSCO End"
...
#define MSG_PAGING_REM_DEV  3146 //"lc_start_paging: bd_addr:0x%04x%04x%04x lt_addr:%d pid:%d"
...
#define MSG_LOG_UART_CMD_ERROR 3193 //"** UART_RX_CMD Err!!"
...
#define LE_MSG_DATA_CH_INVALID_RX_PKT 3218 //"Get Data Channel Invalid Pkt (entry %d header %04x rxstatus %02x)"
...
#define LE_MSG_LL_ADV_PARAS 3226 //"Set AdvPara: type %d addr(loc %d rem %d) Intv(min %d max %d) ChM %d filter(s%d c%d)"
#define LE_MSG_EN_ADV_MODE 3227 //"LL_DRV_EN_ADV: adv_len:%d, pdu_type %d h2h %d intv %d rem-addr %02x %02x %02x %02x %02x %02x"
...
#define LE_MSG_HANDLE_RX_PKT_IN_TASK 3237 //"LE_RX PKT: type %d src %d rx_bytecnt %d conn_entry %d"
#define LE_MSG_ADV_RX_DATA_CONTENT 3238 //"LE ADV Data Content: pdu_type %d offset %d  pdu_len %d (len=%d)"
#define LE_MSG_HEAD_16BYTE 3239 //"Head:%02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x"
...
#define LE_MSG_CREATE_CONN_PARA0 3254 //"LE CreatConn 0: err=%02xh aa=%08xh scan(intv=%d win=%d) fp=%d rem(type=%d addr:%02xh %02xh %02xh %02xh %02xh %02xh)"
...
#define LE_MSG_GEN_LL_CONN_UPDT_REQ 3264 //"[LL]Gen LL_CONN_UPDT_REQ (%d): %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x"
...
#define MSG_MBOX_IN_COMMAND_PARAM 3292 //"[MB] wl2bt => %08x %08x"
#define MSG_MBOX_OUT_COMMAND_PARAM 3293 //"[MB] bt2wl <= %08x %08x"
#define MSG_LE_RSSI_RPT_LOG 3294 //"[rssi]:no_links %d, type %d, addr %02x %02x %02x %02x %02x %02x, rssi_min %d rssi_max %d"
#define MSG_LE_BIND_RSSI_INFO 3295 //"[rssi]: bind rssi => le index %d, rssi blk %d"
#define MSG_LE_RSSI_COUNT_INFO 3296 //"[rssi]: le entry %d index %d rssi count %d rssi sum %d rssi adv %d"
#define MSG_LE_RSSI_S3_RX_PKT 3297 //"[rssi]: le enter s3 receive pkt ... status %d, rssi %d %d %d %d, idx = %d %d, cnt %d"
#define MSG_LE_RSSI_S3_RX_PKT_SIM 3298 //"[rssi]: le enter s3 receive pkt ... status %d"
#define LMP_MSG_RX_NON_EXT_PDU_PRO 3299 //"[clk:0x%08X] <--receive lmp opc:%d %d (addr:%d pid:%d tid:%d ce:%d m:%d) - %02x %02x %02x %02x %02x %02x %02x %02x"
#define MSG_CHECK_AFH_CH_QALITY 3300 //"[sco rf channel %d] : all %d bad %d unkI %d unkII %d hq %d"
#define MSG_CHECK_AFH_MAP_1 3301 //"check_afh_map (m1) : %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x"     
#define MSG_CHECK_AFH_MAP_2 3302 //"check_afh_map (m2) : %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x"     
#define MSG_CHECK_AFH_MAP_3 3303 //"check_afh_map (m3) : %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x"  
#define MSG_CHECK_AFH_SCO_SCORE 3304 //"afh sco_score (%d) : %d %d %d %d %d %d %d %d %d %d : %d %d %d %d %d %d %d %d %d %d"  
#define MSG_CHECK_AFH_SCO_PKT 3305 //"rx sco pkt (ch %d): all %d bad %d sco_hq %d acl all %d.. (bak2 %04x bak3 %04x hq %d miss %d hec err %d)" 
#define MSG_CHECK_AFH_SCORE 3306 //"afh score (%d) : %d %d %d %d %d %d %d %d %d %d : %d %d %d %d %d %d %d %d %d %d"  
#define MSG_CHECK_AFH_PKT_CNT 3307 //"afh pkt cnt (%d) : %d %d %d %d %d %d %d %d %d %d : %d %d %d %d %d %d %d %d %d %d"  
#define MSG_CHECK_AFH_SCO_PKT_CNT 3308 //"afh sco pkt cnt (%d) : %d %d %d %d %d %d %d %d %d %d : %d %d %d %d %d %d %d %d %d %d"  
#define MSG_CHECK_AFH_SCO_PKT_INFO 3309 //"rx sco pkt (ch %d): hq_max %d hq_min %d hq_div %d miss %d hec_err %d" 
#define MSG_CHECK_AFH_ACL_HDR_QALITY 3310 //"afh acl hdr quality (%d) : %d %d %d %d %d %d %d %d %d %d : %d %d %d %d %d %d %d %d %d %d"  
#define MSG_CHECK_ACL_RX_FIFO_MISMATCH 3311 //"acl rx fifo mismatch : wptr (O:%04x -> X:%04x), rptr (%04x), len %d, 1st_word %04x rx_fifo_sta (%04x %04x) !!!!"
#define MSG_CHECK_ACL_RX_FIFO_MISMATCH2 3312 //"auto-flush acl rx fifo (trx cs 0x%x pcd_state 0x%x) !!!"
#define MSG_CHECK_MP_CMD_SET_TEST_CTRL 3313 //"MCMD30_MP_BT_OP_TEST_CTRL_REQ : testCtrl %d, testMode %d, le %d, rx_test %d" 
#define MSG_CHECK_MP_CMD_SET_TEST_MODE 3314 //"MCMD30_MP_BT_OP_SET_BT_MODE_REQ : testMode %d, le %d" 
...
#define GENERATE_AFH_MAP_STATE 3507 //"Generate the AFH map STATE, piconet=>%d, AFH_STATE=> %d"
#define AFH_CAL_CHANNEL_QUALITY 3508 //"Channel index=>%d,   AFH CAL CHANNEL SCORE=> %d"
#define GENERATE_AFH_MAP_FROM_PGR_RTK 3509 //"GENERATE AFH MAP FROM PGR RTK, AFH MAP[0]=> %02x, AFH MAP[1]=>%02x, AFH MAP[2]=>%02x, AFH MAP[3]=>%02x, AFH MAP[4]=>%02x, AFH MAP[5]=> %02x, AFH MAP[6]=> %02x, AFH MAP[7]=> %02x, AFH MAP[8]=>%02x, AFH MAP[9]=> %02x "
#define GENERATE_AFH_MAP_FOR_RECOVERY 3510 //"GENERATE AFH MAP FOR RECOVERY, AFH MAP[0]=> %02x, AFH MAP[1]=>%02x, AFH MAP[2]=>%02x, AFH MAP[3]=>%02x, AFH MAP[4]=>%02x, AFH MAP[5]=> %02x, AFH MAP[6]=> %02x, AFH MAP[7]=> %02x, AFH MAP[8]=>%02x, AFH MAP[9]=> %02x "
...
#define MSG_INQ_DUP_FILTER              3710 //"Inq Dup-Filter : all %d, new %d, mac addr 0x%04x%04x%04x"

//####################################################################

#define MSG_RSSI_HISTORY_LOG 3803 //"receive rssi history : rssi [%d %d %d] cnt [%d %d %d]"
#define MSG_ESCO_TX_STATISTICS 3804 //"eSCO_Tx Statistics: interval cnt %d, ack cnt %d, tx cnt %d"
#define MSG_RX_PKT_STATISTICS 3805 //"RxPkt Statistics: all %d, miss %d, err %d"
...
#define DAPE_TEST_LOG231 3831 //"dape_test_log231: conn_entry:%d, access_address:0x%x, win_size:0x%x, win_offset:0x%x, conn_interval:0x%x, conn_latency:0x%x, sup_to:0x%x, ch_map:0x%x %x %x %x %x, hop:0x%x, masterSCA:0x%x"
...
#define DAPE_TEST_LOG274 3874 //"[LL] LL Ctrl PDU received, opcode:%d, m:%d, entry:%d, len:%d, pause_enc_state:%d, start_enc_state:%d"
...
#define DAPE_TEST_LOG427 4127 //"dape_test_log427: i:%d, ce_interval:%d, initiator_unit.conn_interval:%d, ce_interval_same:%d, ce_interval_min:%d, ce_interval_second_min:%d"
...
#define DAPE_TEST_LOG431 4131 //"dape_test_log431: conn_entry:%d, role:%d, full_real_anchor_point:0x%x, real_anchor_point:0x%x, anchor_point_slot:0x%x, phandle->slot_offset:%d, conn_interval_slot:%d"
...
#define DAPE_TEST_LOG536 4636 //"[clk:0x%08X](%d) SET PageScan Back to Normal(%d:%d). original(%d:%d)."
#define DAPE_TEST_LOG537 4637 //"[clk:0x%08X] FHS pkt received."
#define DAPE_TEST_LOG538 4638 //"[clk:0x%08X](%d) SHORTEN PageScanIntv(%d:%d). original(%d:%d)."
#define DAPE_TEST_LOG539 4639 //"[clk:0x%08X](%d) SHORTEN PageScanIntv Function called but not set.(%d:%d)."
#define DAPE_TEST_LOG540 4640 //"[clk:0x%08X] HID Found!!"
#define DAPE_TEST_LOG541 4641 //"[clk:0x%08X] Role SW!! (flag:%d, mss_state:%d). Nofity wifi."
#define DAPE_TEST_LOG542 4642 //"Correct HCI_LE_CONNECTION_COMPLETE_EVENT %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x"
#define DAPE_TEST_LOG544 4644  //"<----HCI_EVENT:code:%02x len:%d, %02x %02x %02x %02x"
...
#define CCH_DBG_046 6046 //"sniff_interval =%02d sniff_attempt=%02d"
...
#define CCH_DBG_144 6144 //"32k Calibration NOT READY!! lps_32k_cal_count = 0x%x"
#define CCH_DBG_145 6145 //"[PTA] Scan Response DeadLock 0x%x  0x%x"
#define CCH_DBG_146 6146 //"[Vendor] BB_RESET~"
#define CCH_DBG_147 6147 //" num_hlc = 0x%x, LE.conn = 0x%x, LE__cnts = 0x%x CE_STATUS: 0x%02x 0x%02x 0x%02x 0x%02x 0x%02x 0x%02x 0x%02x 0x%02x 0x%02x 0x%02x "
#define CCH_DBG_148 6148 //" num_hlc = 0x%x, CE_STATUS: 0x%02x 0x%02x 0x%02x 0x%02x"
#define CCH_DBG_149 6149 //"%08x %08x %08x %08x %08x %08x %08x %08x %08x %08x %08x %08x %08x %08x %08x %08x"
#define CCH_DBG_150 6150 //"ACL_TX_BUF FULL"
#define CCH_DBG_151 6151 //"Gen Num of Complete Packet Event: handle = 0x%x"
...
#define CCH_LPS_001 6301 //"(LPS) lps_period_count = %d, lps_period_state = %d, bitmap = 0x%x, lps_mode = %x"
...
#define DMA_UART_026 9026 //"<DMA UART> g_hci_uart_pll_ckrdy_timeout = %d, g_hci_uart_pll_ckrdy_timeout_en = %d, g_hci_uart_det_timeout_LPS_en = %d, g_hci_uart_tune_pll_sel_en = %d, g_hci_uart_afe_turn_off_en = %d, g_hci_uart_en0_before_set_en = %d"
...
#define DMA_UART_034 9034 //"<DMA UART> g_hci_uart_pll_ldo_stable_loops = %d, g_hci_uart_err_send_event_en = %d, g_hci_uart_baud_redet_en = %d, g_hci_uart_det_wait_en = %d, g_hci_uart_redet_wait_en = %d, g_hci_uart_ck_timeout_afe_off_en = %d"
...
#define DMA_UART_074 9074 //"<BT DMA> isr_status = 0x%08x"
...
#define DMA_UART_128 9128  //"<WIN8 PORTING> execute rcp_wake_up_host_imp():   Drive LED1;"
#define DMA_UART_129 9129  //"<WIN8 PORTING> patch_S3C2410Usb_Dma():   check g_host_state = %d;"
#define DMA_UART_130 9130  //"<WIN8 PORTING> patch_S3C2410Usb_Dma():   g_host_state = 1; go to wake_up_host();"
#define DMA_UART_131 9131  //"<WIN8 PORTING> patch_S3C2410Usb_Dma():   execute with packet type: %d"
#define DMA_UART_132 9132  //"<WIN8 PORTING> g_host_state = %d"

#define YL_DBG_HEX_1 9152 //"<YL DBG - 1> 0x%X"
...
#define LPS_LOG_018 9318 //"<LPS> BB_handle_start_of_sniff_attemp_interrupt(lut_index = %d) STARTs..."
#define LPS_LOG_019 9319 //"<LPS> BB_handle_end_of_sniff_attemp_interrupt(lut_index = %d) STARTs..."
...
#define LPS_LOG_040 9340  //"<LPS> lc_handle_sm_intr() at Instant = 0x%x  (Wakeup Instant = 0x%x) write_bb_reg_count = 0x%x"
#define LPS_LOG_041 9341 //"<LPS> Using External 32.768k"
#define LPS_LOG_042 9342 //"<LPS> Using Internal 32k"
#define LPS_LOG_043 9343 //"<LPS> lc_handle_sm_intr() at Instant = 0x%x  (Wakeup Instant = 0x%x) isr_switch = %d  gpio pin = 0x%X  gpio intsts = 0x%X"
#define LPS_LOG_044 9344 //"<LPS> lc_handle_sm_intr() at Instant = 0x%x  (Wakeup Instant = 0x%x) g_dsm_cnt = %d  gpio pin = 0x%X  gpio intsts = 0x%X"
...
#define LC_PCM_CODEC_REG  5001  //" PCM Codec Reg, 0x9E=%04x, 0xDE=%04x, 0x1EC = %04x, 0x1EE = %04x"
...
#define MSG_RSSI_PKT_SOURCE 5006 //"[PKT_RECD_SIGNAL] ori %d %d : new %d %d"
#define MSG_WIFI_MP_DISCONNECT 5007 //"[mp] disconnect %d handle %d"
#define MSG_WIFI_MP_SET_MODE 5008 //"[mp] WIFI_MBOX_SET_MODE = %d"
#define MSG_WIFI_MP_GEN_SYNWORD 5009 //"[mp] SyncWord Gen = target_addr %02x %02x %02x syncword = 0x%04x%04x%04x%04x"
// ============== morgan add pta ========
...
#define PTA_DISPLAY_FHS_MESSAGE 12006 //"<PTA FHS> display FHS message EIR=0x%x BD_ADDR=0x%x 0x%x 0x%x  0x%x 0x%x 0x%x CoD=0x%x 0x%x 0x%x LT_ADDR=0x%x"
...
#define PTA_DISPLAY_BT_INFO_MESSAGE 12041 //"<PTA> BT MESSAGE Connection=  %d SCO= %d INQ= %d ACL=%d SCO busy= %d TXRetry=%d HID=%d A2DP=%d FTP=%d"
...
#define PTA_DISPLAY_BT_INFO_MESSAGE3 12047 //"<PTA> Conn=%d SCO=%d INQ=%d ACL=%d SCO busy=%d TXRetry=%d HID=%d A2DP=%d FTP=%d rssi_adv %d rssi_sum %d pkt_cnt=%d"
#define PTA_DISPLAY_BT_INQ_PAGE_MESSAGE 12048 //"<PTA> INQ page = 0x%X flag = 0x%X"
//===================================special used index=================================
