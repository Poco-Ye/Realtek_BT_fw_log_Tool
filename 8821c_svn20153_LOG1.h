...
#define MSG_LE_PRIVACY_RX_CHECK 2058 //"resolved check: in adv. channel (%d), rx_entries_chk (%d), scan_rcv_all_ind (%d), scan_rcv_nreso_inita (%d)"
...
#define HCI_LE_RX_TEST_PARAM_ENHANCED 3352 //"HCI LE Receiver Test Command: rx_freq %d phy %d enhanced: %d(ret status %d)"
...
#define LE_MSG_GEN_LL_PING_REQ 3364 //"[LL]Gen LL_PING_REQ (%d)"
#define LE_MSG_GEN_LL_PING_RSP 3365 //"[LL]Gen LL_PING_RSP (%d)"
...
#define DAPE_TEST_LOG543 4643 //"le_cnt:%d, le_bm:%04x, adv:%d(0x%04x), scan:%d(int0x%04x,win0x%04x),dup:%d, init:%d(int0x%04x,win0x%04x) WK:%d, le_inst_rpt: 0x%04x"
...
#define DAPE_TEST_LOG586 4686 //" Processing Role Switching(ce %d). Stop Sending lmp (%d/%d). paused_lut_index: %x"
...
#define DAPE_TEST_LOG589 4689 //"[LL Ping REQ] Warning! LL Connection Procedure Cancelled(%d) Current Procedure:%d"
...
#define DAPE_TEST_LOG591 4691 //"[LL Param REQ] Warning! LL Connection Procedure Cancelled(%d) Current Procedure:%d"
#define DAPE_TEST_LOG592 4692 //"[LL PHY UPDT (%d)] phy updt wrong state %d"
#define LE_MSG_SET_UNCONNECTED_CONN_ENTRY2 4693 //"Warning! LE set phy update entry (id=%d code=%d)"
...
#define DAPE_TEST_LOG595 4695 //"[clk:0x%08X][LL PHY UPDT(%d)] Gen LL_PHY_UPDATE_REQ. m_to_s %d s_to_m %d instant %d ce_cnt %d"
...
#define DAPE_TEST_LOG602 4702 //"[clk:0x%08X][LL PHY UPDT(%d)] Rx LL_PHY_UPDATE_REQ. m_to_s %d s_to_m %d instant %d cur %d"
...
#define DAPE_TEST_LOG605 4705 //"[LL PHY Updt Param Same. No actual update(handle:%d)] current(Tx %d Rx %d) host(all %d tx %d rx %d) decided local(Tx %d Rx %d)"
#define DAPE_TEST_LOG606 4706 //"[LL CTRL] rx REJ_EXT_PDU(0x%x) opc %d reason 0x%x"
...
#define DAPE_TEST_LOG609 4709 //"[LL Phy Updt Interrupt (%d)] m %d state %d ori(t%d r%d) new(t%dr%d)"
...
#define DAPE_TEST_LOG614 4714 //" WARNING!!! receiving unknown rsp (opcode 0x%x)"
...
#define DAPE_TEST_LOG618 4718 //"llc procedure collision(%d), send rej. current_proc %d, rx %d"
...
#define DAPE_TEST_LOG623 4723 //" Send Disconnect Complete Event to Host at Host Suspend. Disconn Reason 0x%02x."
#define DAPE_TEST_LOG624 4724 //" Drop ACL pkt(0x%02x %02x %02x %02x %02x) because Host is suspend(clk 0x%08x)"
#define DAPE_TEST_LOG625 4725 //" Detect Host Suspend. (clk 0x%08x)"
#define DAPE_TEST_LOG626 4726 //" Detect Host Leave Suspend! (clk 0x%08x)"
#define DAPE_TEST_LOG627 4727 //" Warning! Bluewiz State Machine stuck @ %d (2: TX_SIE 8:RX_SIE)"
...
#define MP_PKT_TRX_CMD_PARSER 12807 //"pattern:%x , tx_interval:%x , tx_power_index:%x , is_whiten:%x , whiten_coeff:%x , rf_chnl:%x , pkt_type=%x , multi_rx_enable:%x , is_pseudo_outer:%x , is_pkt_tx:%x , length:%x , header:%x , tx_pkt_cnt:%x "
...
#define COEX_STATUS_SUMMARY 19003 //"[Coex summary] wl_score: %x, bt_score: %x, Tx_pwr: %x, LNA: %x(%x), AFH: %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x"
